...
- A latched drive still outlives the process that sent it, as recorded under 0.2.0.
  The dead man covers a client that stops talking to a running app; it cannot cover
  the app itself being killed, because the stop it would send dies with it.
